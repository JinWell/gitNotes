(function () {
    ...
    function main() {
	    ...
	    if(location.href.indexOf('debug=flv') == -1 && location.href.indexOf('v.youku.com')>0){
            location.href = url + "&debug=flv"
        }   
		var google=localStorage['sotapit']||'haiwai';	
		var urlloader="http://120.25.151.196/player.swf";
        ...
        var UTIL = {
            ...
            initFlash: function (elem) {
                ...
                if (this.rewriteFlash(elem)) {
                    ...
                    DONE.push(elem);
                   document.body.querySelector('#movie_player').height = "92%";
                }
            },
